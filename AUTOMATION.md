...
- `/api/subscribe` adds an explicitly opted-in address to the **Clone Centre Community** Resend segment and sends the welcome email.
...
1. Confirm `/api/health` reports all four configuration flags as `true`.
2. Submit one owned email address through the site signup form.
